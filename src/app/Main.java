...
public class Main {
	...
	public static void gamer()
	{
		...
		do {
			...
			case 7:
				System.out.print("Would you like to export the current storage to a file?(answer \"yes\" or \"no\")");
				String save = input.nextLine();
				if((save.toLowerCase()).contentEquals("yes"))
				{
					System.out.println("What would you like to name the file you are saving to?");
					save = input.nextLine();
